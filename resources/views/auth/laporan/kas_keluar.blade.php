    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active bg-gradient-primary" href="{{ url('/laporan/kas_keluar') }}">
                        <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">receipt_long</i>
                        </div>
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Kas Keluar</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Kas Keluar</h6>
            </nav>
...
@section('content')
                ...
                <div class="card-header pb-0">
                    ...
                    <div class="row justify-content-between mb-3">
                        <div class="col-md-6">
                            ...
                            <div class="row mb-3">
                                <form method="GET" action="{{ url('/laporan/kas_keluar') }}"
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="row px-2">
                                <div class="col-12 p-0 m-0 d-flex justify-content-between align-items-center mt-4">
                                    <!-- Export Excel Form -->
                                    <form method="GET" action="{{ url('/laporan/kas_keluar/export_excel') }}">
                                        @csrf
                                    ...
                                    <!-- Export PDF Form -->
                                    <form method="GET" action="{{ url('/laporan/kas_keluar/export_pdf') }}" target="_blank">
                                        @csrf
                ...
                <div class="card-body px-3 pt-0 pb-2" style="min-height: 430px;">
                    <div class="table-responsive p-0" style="min-height:380px; overflow-y: auto;">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="8" class="text-center">
                                            <p class="fw-light text-sm mt-5">Tidak ada kas keluar hari ini.</p>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
                        ...
                        <div class="text-center mt-5" id="noResultsMessage_Data" style="display: none;">
                            <p class="fw-light text-sm mt-5">Kas keluar tidak ditemukan.</p>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title font-weight-bold">Tambah Kas Keluar</h4>
                </div>
                <div class="modal-body">
                    <form method="POST" action="{{ url('/laporan/kas_keluar/create') }}">
                        @csrf
                        ...
                        <div class="input-group mb-3 input-group-outline">
                            <input name="jumlah" type="number" class="form-control"
                                placeholder="Masukkan jumlah pengeluaran" aria-label="jumlah" value="">
                        </div>
    ...
    @foreach ($data_table as $keuangan)
        <div class="modal fade" id="editKeuangan{{ $keuangan->id_keuangan }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title font-weight-bold">Edit Kas Keluar</h4>
                    </div>
                    <div class="modal-body">
                        <form method="POST" action="{{ url('/laporan/kas_keluar/edit/' . $keuangan->id_keuangan) }}">
                            @csrf
                            <label>Tanggal <span class="text-danger">*</span></label>
                            <div class="input-group mb-3 input-group-outline">
                                <input type="date" name="tanggal" class="form-control px-1"
                            ...
                            <div class="input-group mb-3 input-group-outline">
                                <input name="jumlah" type="number" class="form-control"
                                    placeholder="Masukkan jumlah pengeluaran" aria-label="jumlah"
    ...
    @foreach ($data_table as $keuangan)
        <div class="modal fade" id="confirmDeleteKeuangan{{ $keuangan->id_keuangan }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form action="{{ url('/laporan/kas_keluar/delete/' . $keuangan->id_keuangan) }}" method="POST"
                        ...
                        <div class="modal-body">
                            Apakah Anda yakin ingin menghapus kas keluar ini?
                        </div>
