    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active bg-gradient-primary" href="{{ url('/laporan/buku_besar') }}">
                        <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">receipt_long</i>
                        </div>
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Buku Besar</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Buku Besar</h6>
            </nav>
                        ...
                        <div class="col-md-5">
                            <div class="row">
                                <div class="d-flex align-items-center text-dark mb-3">
                                    ...
                                    <form action="{{ url('laporan/buku_besar') }}" method="get"
                            ...
                            <div class="row mb-3">
                                <form method="GET" action="{{ url('/laporan/buku_besar') }}" class="row">
                                    @csrf
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="row px-2">
                                <div class="col-12 p-0 m-0 d-flex justify-content-between align-items-center mt-4">
                                    <!-- Export Excel Form -->
                                    <form method="GET" action="{{ url('/laporan/buku_besar/export_excel') }}">
                                        @csrf
                                    ...
                                    <!-- Export PDF Form -->
                                    <form method="GET" action="{{ url('/laporan/buku_besar/export_pdf') }}" target="_blank">
                                        @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @if ($keuangan['kategori'] == 'Debet')
                                                <p class="text-sm mb-0">
                                                    <span class="badge bg-gradient-success">Debet</span>
                                                </p>
                                            @else
                                                <p class="text-sm mb-0">
                                                    <span class="badge bg-gradient-danger">Kredit</span>
                                                </p>
                                            @endif
                                        </td>
                                        <td class="text-center">
                                        ...
                                        <td class="text-center">
                                            <p class="text-sm font-weight-light mb-0"> Rp.
                                                {{ number_format($keuangan['debet'], 0, ',', '.') }}
                                            </p>
                                        </td>
                                        <td class="text-center">
                                            <p class="text-sm font-weight-light mb-0"> Rp.
                                                {{ number_format($keuangan['kredit'], 0, ',', '.') }}
                                            </p>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="8" class="text-center">
                                            <p class="fw-light text-sm mt-5 mb-5">Tidak ada pesanan hari ini.</p>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
                            <tfoot
                                style="position: sticky; bottom: 0; z-index: 10; background-color:#f7f7f7">
                                <tr style="border-top: 1px solid #f0f2f5; ">
                                    <td colspan="4" rowspan="2" class="text-center">
                                        <p class="text-sm font-weight-bold mb-0">Total Laba</p>
                                    </td>
                                    <td class="text-center">
                                        <p class="text-sm font-weight-light text-success mb-0">Rp.
                                            {{ number_format($totalDebet, 0, ',', '.') }}</p>
                                    </td>
                                    <td class="text-center">
                                        <p class="text-sm font-weight-light text-danger mb-0">Rp.
                                ...
                                <tr>
                                    <td colspan="2" class="text-center">
                                        <p class="text-sm font-weight-bold mb-0">Rp.
                                            {{ number_format($totalDebet - $totalKredit, 0, ',', '.') }}</p>
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
