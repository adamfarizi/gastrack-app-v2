    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active bg-gradient-primary" href="{{ url('/laporan/laporan_bop') }}">
                        <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">receipt_long</i>
                        </div>
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Laporan BOP</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Laporan BOP</h6>
            </nav>
                ...
                <div class="card-header pb-0">
                    ...
                    <div class="row justify-content-between mb-3">
                        <div class="col-md-5">
                            ...
                            <div class="row mb-3">
                                <form method="GET" action="{{ url('/laporan/laporan_bop') }}" class="row">
                                    @csrf
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="row px-2">
                                <div class="col-12 p-0 m-0 d-flex justify-content-between align-items-center mt-4">
                                    <!-- Export Excel Form -->
                                    <form method="GET" action="{{ url('/laporan/laporan_bop/export_excel') }}">
                                        @csrf
                                    ...
                                    <!-- Export PDF Form -->
                                    <form method="GET" action="{{ url('/laporan/laporan_bop/export_pdf') }}" target="_blank">
                                        @csrf
                    ...
                    <div class="table-responsive p-0" style="min-height:380px; overflow-y: auto;">
                        <table class="table align-items-center mb-0" id="table_Data">
                            ...
                            <tbody id="table_Data_body" class="text-dark">
                                @forelse($data_table as $pengiriman)
                                    <tr>
                                        <td class="text-center">
                                            <p class="text-sm font-weight-bold mb-0">
                                                {{ $pengiriman->kode_pengiriman }}</p>
                                        </td>
                                        @if (!$pengiriman->waktu_pengiriman)
                                            <td class="text-center">
                                                <p class="text-sm font-weight-light text-danger mb-0">Belum Dikirim</p>
                                            </td>
                                        @else
                                            <td class="text-center">
                                                @php
                                                    // Mengonversi tanggal ke format yang diinginkan
                                                    $tanggalPengiriman = \Carbon\Carbon::parse(
                                                        $pengiriman->waktu_pengiriman,
                                                    );
                                                    $formattedDate = $tanggalPengiriman->translatedFormat('d-M-Y'); // Format: Hari, tanggal-bulan-tahun
                                                    $formattedTime = $tanggalPengiriman->format('H:i'); // Format: Jam
                                                @endphp
                                        ...
                                        <td class="text-center">
                                            @if (!$pengiriman->sopir)
                                                <p class="text-sm font-weight-light text-danger mb-0">Belum Dikirim</p>
                                            @else
                                                <p class="text-sm font-weight-light mb-0">{{ $pengiriman->sopir->nama }}
                                                </p>
                                            @endif
                                        </td>
                                        <td class="text-center">
                                            <p class="text-sm font-weight-light mb-0"> Rp.
                                                {{ number_format($pengiriman->pesanan->transaksi->pelanggan->bop_pelanggan, 0, ',', '.') }}
                                            </p>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center">
                                            <p class="fw-light text-sm mt-5">Tidak ada pengiriman hari ini.</p>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
