    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active bg-gradient-primary" href="{{ url('/laporan/omzet_penjualan') }}">
                        <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">receipt_long</i>
                        </div>
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Omzet Penjualan</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Omzet Penjualan</h6>
            </nav>
                        ...
                        <div class="col-md-5">
                            <div class="row">
                                <div class="d-flex align-items-center text-dark mb-3">
                                    ...
                                    <form action="{{ url('laporan/omzet_penjualan') }}" method="get"
                            ...
                            <div class="row mb-3">
                                <form method="GET" action="{{ url('/laporan/omzet_penjualan') }}" class="row">
                                    @csrf
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="row px-2">
                                <div class="col-12 p-0 m-0 d-flex justify-content-between align-items-center mt-4">
                                    <!-- Export Excel Form -->
                                    <form method="GET" action="{{ url('/laporan/omzet_penjualan/export_excel') }}">
                                        @csrf
                                    ...
                                    <!-- Export PDF Form -->
                                    <form method="GET" action="{{ url('/laporan/omzet_penjualan/export_pdf') }}" target="_blank">
                                        @csrf
                ...
                <div class="card-body px-3 pt-0 pb-2" style="min-height: 430px;">
                    <div class="table-responsive p-0" style="min-height:380px; overflow-y: auto;">
                        <table class="table align-items-center mb-0" id="table_Data">
                            ...
                            <tfoot
                                style="border-top: 1px solid #f0f2f5; position: sticky; bottom: 0; z-index: 10; background-color:#f7f7f7 ">
                                <tr>
                                    <td colspan="5" class="text-center">
                                        <p class="text-sm font-weight-bold mb-0">Total Omzet</p>
                                    </td>
                                    <td class="text-center">
