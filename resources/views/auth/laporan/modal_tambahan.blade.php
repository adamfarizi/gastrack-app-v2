    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active bg-gradient-primary" href="{{ url('/laporan/modal_tambahan') }}">
                        <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">receipt_long</i>
                        </div>
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Modal Tambahan</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Modal Tambahan</h6>
            </nav>
...
@section('content')
                ...
                <div class="card-header pb-0">
                    <div class="row mb-3">
                        <div class="col d-flex align-items-center">
                            <h4 class="card-title">Modal Tambahan</h4>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="d-flex align-items-center text-dark mb-3">
                                    ...
                                    <form action="{{ url('laporan/laporan_bop') }}" method="get"
                            ...
                            <div class="row mb-3">
                                <form method="GET" action="{{ url('/laporan/modal_tambahan') }}"
                                    class="row col-md-9 pe-0">
                                    @csrf
                                ...
                                <div class="col-md-3 p-0 d-flex align-items-end">
                                    <div class="px-2 mt-2">
                                        <a class="btn btn-icon btn-3 btn-info m-0" data-bs-toggle="modal"
                                            data-bs-target="#createKeuangan" type="button">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="row px-2">
                                <div class="col-12 p-0 m-0 d-flex justify-content-between align-items-center mt-4">
                                    <!-- Export Excel Form -->
                                    <form method="GET" action="{{ url('/laporan/modal_tambahan/export_excel') }}">
                                        @csrf
                                    ...
                                    <!-- Export PDF Form -->
                                    <form method="GET" action="{{ url('/laporan/modal_tambahan/export_pdf') }}" target="_blank">
                                        @csrf
                ...
                <div class="card-body px-3 pt-0 pb-2" style="min-height: 430px;">
                    <div class="table-responsive p-0" style="min-height:380px; overflow-y: auto;">
                                    ...
                                    <tr>
                                        <td class="text-center text-dark">
                                            @if ($keuangan->jenis == 'debet')
                                                <p class="text-sm font-weight-bold mb-0">Debet</p>
                                            @else
                                                <p class="text-sm font-weight-bold mb-0">Kredit</p>
                                            @endif
                                        </td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <ul class="shadow dropdown-menu px-2 py-3 ms-sm-n4 ms-n5"
                                                aria-labelledby="dropdownTable">
                                                <li>
                                                    <a href="#" class="dropdown-item border-radius-md"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#editKeuangan{{ $keuangan->id_keuangan }}">
                                                ...
                                                <li>
                                                    <a href="#" class="dropdown-item border-radius-md"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#confirmDeleteKeuangan{{ $keuangan->id_keuangan }}">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="8" class="text-center">
                                            <p class="fw-light text-sm mt-5">Tidak ada modal tambahan hari ini.</p>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
                        ...
                        <div class="text-center mt-5" id="noResultsMessage_Data" style="display: none;">
                            <p class="fw-light text-sm mt-5">Modal tambahan tidak ditemukan.</p>
                        </div>
                    </div>
    ...
    {{-- Modal Create --}}
    <div class="modal fade" id="createKeuangan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title font-weight-bold">Tambah Modal</h4>
                </div>
                <div class="modal-body">
                    <form method="POST" action="{{ url('/laporan/modal_tambahan/create') }}">
                        @csrf
                        <label>Tanggal <span class="text-danger">*</span></label>
                        <div class="input-group mb-3 input-group-outline">
                            <input type="date" name="tanggal" class="form-control px-1"
                                value="{{ \Carbon\Carbon::today()->format('Y-m-d') }}">
                        </div>
                        <label>Jumlah <span class="text-danger">*</span></label>
                        <div class="input-group mb-3 input-group-outline">
                            <input name="jumlah" type="number" class="form-control"
                                placeholder="Masukkan jumlah tambahan" aria-label="jumlah" value="">
                        </div>
    ...
    {{-- Modal Edit --}}
    @foreach ($data_table as $keuangan)
        <div class="modal fade" id="editKeuangan{{ $keuangan->id_keuangan }}" tabindex="-1" role="dialog"
            aria-labelledby="confirmDeleteSopirLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title font-weight-bold">Edit Modal</h4>
                    </div>
                    <div class="modal-body">
                        <form method="POST"
                            action="{{ url('/laporan/modal_tambahan/edit/' . $keuangan->id_keuangan) }}">
                            @csrf
                            <label>Tanggal <span class="text-danger">*</span></label>
                            <div class="input-group mb-3 input-group-outline">
                                <input type="date" name="tanggal" class="form-control px-1"
                                    value="{{ $keuangan->tanggal ? \Carbon\Carbon::parse($keuangan->tanggal)->format('Y-m-d') : \Carbon\Carbon::today()->format('Y-m-d') }}">
                            </div>
                            <label>Jumlah <span class="text-danger">*</span></label>
                            <div class="input-group mb-3 input-group-outline">
                                <input name="jumlah" type="number" class="form-control"
                                    placeholder="Masukkan jumlah tambahan" aria-label="jumlah"
                                    value="{{ $keuangan->jumlah }}">
                            </div>
                            <label for="deskripsi">Deskripsi <span class="text-danger">*</span></label>
                            <div class="input-group mb-3 input-group-outline">
                                <textarea name="deskripsi" id="deskripsi" rows="4" class="form-control">{{ $keuangan->deskripsi }}</textarea>
                            </div>
                            <div class="text-center ">
                                <button type="submit" name="submit" class="btn bg-gradient-primary w-100 mt-4 mb-0"
                                    values="Tambah">Update</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    {{-- Modal Delete --}}
    @foreach ($data_table as $keuangan)
        <div class="modal fade" id="confirmDeleteKeuangan{{ $keuangan->id_keuangan }}" tabindex="-1" role="dialog"
            aria-labelledby="confirmDeleteSopirLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <form action="{{ url('/laporan/modal_tambahan/delete/' . $keuangan->id_keuangan) }}" method="POST"
                        ...
                        <div class="modal-body">
                            Apakah Anda yakin ingin menghapus modal tambahan ini?
                        </div>
