...
<head>
    ...
    <title>Detail Penjualan | Tanggal: {{ $tanggal_awal }} sd {{ $tanggal_akhir }}</title>
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td style="vertical-align: top; text-align: right;">
                <div>
                    <p class="mb-0"><strong>DETAIL PENJUALAN</strong></p>
    ...
    <div>
        <table class="table table-sm table-bordered">
            <thead class="text-center" style="font-size: 12px">
                <tr>
                    <th class="px-0 align-middle">Resi</th>
                    <th class="px-0 align-middle">Tanggal Pesanan</th>
                    <th class="px-0 align-middle">Pelanggan</th>
                    <th class="px-0 align-middle">Tujuan</th>
                    <th class="px-0 align-middle">Jumlah Pesanan</th>
                    <th class="px-0 align-middle">Harga</th>
                    <th class="px-0 align-middle">Waktu Payment</th>
                    <th class="px-0 align-middle">Payment Methode</th>
                </tr>
            </thead>
            <tbody style="font-size: 11px;">
                @forelse($data_table as $pesanan)
                    <tr>
                        ...
                        <td>
                            <p class="mb-0">{{ $pesanan->jumlah_bar }} bar</p>
                        ...
                        <td>
                            @if (
                                ...
                                <p>
                                    Jam : {{ date('H:i', strtotime($pesanan->transaksi->tagihan->tanggal_pembayaran)) }}
                                </p>
                            @else
