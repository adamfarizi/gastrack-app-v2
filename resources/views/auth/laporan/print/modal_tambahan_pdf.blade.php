...
<head>
    ...
    <title>Modal Tambahan | Tanggal: {{ $tanggal_awal }} sd {{ $tanggal_akhir }}</title>
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td style="vertical-align: top; text-align: right;">
                <div>
                    <p class="mb-0"><strong>MODAL TAMBAHAN</strong></p>
    ...
    <div>
        <table class="table table-sm table-bordered">
            <thead class="text-center" style="font-size: 12px">
                <tr>
                    <th class="px-0 align-middle">Jenis Akun Bayar</th>
                    <th class="px-0 align-middle">Tanggal</th>
                    <th class="px-0 align-middle">Deskripsi</th>
                    <th class="px-0 align-middle">Jumlah Modal</th>
                </tr>
            </thead>
